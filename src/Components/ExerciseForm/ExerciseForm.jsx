    ...
    return (
        <div className='exerciseForm'>
            <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <br />
                <label>Distance</label>
                <input {...register("distance", { required: true })} disabled={activity == 'Run' ? false : true} />
                {errors.distance && <p>Distance is required</p>}
                <label >Date </label>
                <input type="datetime-local"  {...register("date", { required: true })} />
                {errors.dutation && <p>Date is required</p>}
                <label >Dutation </label>
                <input type="time" {...register("dutation", { required: true })} />
                {errors.dutation && <p>Dutation is required</p>}
                <label >Calories</label>
                <input type="number" placeholder="Calories" {...register("calories", { required: true })} />
                {errors.dutation && <p>Calories is required</p>}
                <label >Heart Rate</label>
                <input type="number" placeholder="Heart Rate" {...register("heartrate", { required: true })} />
